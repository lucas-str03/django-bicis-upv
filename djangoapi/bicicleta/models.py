...
class Barrio(models.Model):
    ...
    # Geometría: MultiPolygon porque un barrio puede tener "islas"
...
class CarrilBici(models.Model):
    tipo = models.CharField(max_length=50) # Ejemplo: Ciclocalle, Carril-bici, etc.
...
class EstacionBicicleta(models.Model):
    ...
    # Estos campos se actualizarán con la API de Valencia
